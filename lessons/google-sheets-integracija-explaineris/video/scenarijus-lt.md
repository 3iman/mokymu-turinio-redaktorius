...
**Trukmė:** 286 sek. be intro, outro ir skirtukų (~5:34 su jais)
...
| 9 Lentelė yra duomenų bazė | 26 sek. | 08-duomenu-baze | Lentelė čia veikia kaip duomenų bazė – svarbiausia tvarka, ne stilius. Langelyje neturi būti nei perkėlimo į naują eilutę, nei formulių, nei sujungtų langelių. Tinka tai, kas paruošta: A stulpelio žymos ir vienas formatas vienai eilutei. Sudėtingesnis formatavimas svetainėje nesimato. Todėl šabloną verta palikti tokį, koks yra. |
| 10 Lapų tvarka | 20 sek. | 09-lapu-tvarka | Pirmas lapas visada turi gID nulis. Jo vietos keisti nereikėtų – svetainė jį atpažįsta būtent pagal šį numerį. Kitus lapus galima perkelti ar pervadinti laisvai. Sistema juos atpažįsta pagal gID, ne pagal vietą. |
| 11 Keli failai pagal atsakomybes | 22 sek. | 10-organizavimas | Visas lenteles galima sudėti į vieną failą, bet patogiau skaidyti pagal atsakomybes. Pavyzdžiui, administracijos ir ugdymo lentelės gyvena atskirai. Taip aišku, kuris failas kam priklauso, klaida paliečia tik vieną failą, o skirtingi žmonės dirba vienas kitam netrukdydami. |
| 12 Ką matote atidarę | 20 sek. | 11-sablonas | Atidarę failą matote, kad darbas jau pradėtas. Lapai paruošti dažniausioms lentelėms: taryba, komisijos, darbo užmokestis. Antraštės ir stulpeliai jau sudėlioti – lieka duomenys. O jei kurios nors lentelės nereikia, tiesiog jos nepildote. |
...
### KADRAS 1: Kodėl tai naudinga (22 sek.)
**Failas:** `00-kodel.png`
...
| 6.0 | balsas | Lentelei pakeisti nebereikia jungtis prie turinio valdymo sistemos. |
| 10.6 | balsas | Šablonai jau paruošti – užpildote tik duomenis. |
| 14.2 | balsas | Prieigą gali turėti keli darbuotojai, tad atsakomybes galima pasidalyti. |
| 19.0 | balsas | O suintegruojama vieną kartą. |

### KADRAS 2: Kaip tai veikia (26 sek.)
...
| 22.4 | balsas | Pagal juos puslapis ir žino, kurią lentelę imti. |
...
| 10.2 | balsas | Jūs pildote lenteles, dalijatės prieiga su kolegomis |
| 15.0 | balsas | ir parašote mums tada, kai kas nors nepavyksta. |
| 18.6 | balsas | Šablono kopijuoti patiems nebereikia. |
...
| 20.4 | balsas | Vėliau keičiasi tik duomenys faile. |

### KADRAS 7: Modulis sistemoje (22 sek.)
...
| 5.6 | balsas | Kiekvienas atpažįstamas pagal pavadinimą, kurį suteikiame patys. |
...
| 19.2 | balsas | Išjungto failo lentelės nematyti. |
...
| 12.6 | balsas | Ar redaguojate tą pačią prijungtą lentelę. |
| 16.2 | balsas | Ir ar tikrai išėjote iš langelio. |

### KADRAS 9: Lentelė yra duomenų bazė (26 sek.)
...
| 13.0 | balsas | Tinka tai, kas paruošta: A stulpelio žymos ir vienas formatas vienai eilutei. |
| 19.0 | balsas | Sudėtingesnis formatavimas svetainėje nesimato. |
| 22.2 | balsas | Todėl šabloną verta palikti tokį, koks yra. |

### KADRAS 10: Lapų tvarka (20 sek.)
...
| 4.6 | balsas | Jo vietos keisti nereikėtų – svetainė jį atpažįsta būtent pagal šį numerį. |
| 10.4 | balsas | Kitus lapus galima perkelti ar pervadinti laisvai. |
| 15.0 | balsas | Sistema juos atpažįsta pagal gID, ne pagal vietą. |

### KADRAS 11: Keli failai pagal atsakomybes (22 sek.)
...
| 7.0 | balsas | Pavyzdžiui, administracijos ir ugdymo lentelės gyvena atskirai. |
| 11.6 | balsas | Taip aišku, kuris failas kam priklauso, |
| 14.6 | balsas | klaida paliečia tik vieną failą, |
| 17.4 | balsas | o skirtingi žmonės dirba vienas kitam netrukdydami. |

### KADRAS 12: Ką matote atidarę (20 sek.)
...
| 15.4 | balsas | O jei kurios nors lentelės nereikia, tiesiog jos nepildote. |
